...
exports.SupabaseUserGuard = void 0;
const common_1 = require("@nestjs/common");
const config_1 = require("@nestjs/config");
const supabase_js_1 = require("@supabase/supabase-js");
let SupabaseUserGuard = class SupabaseUserGuard {
    configService;
    supabase;
...
exports.SupabaseUserGuard = SupabaseUserGuard;
exports.SupabaseUserGuard = SupabaseUserGuard = __decorate([
    (0, common_1.Injectable)(),
    __metadata("design:paramtypes", [config_1.ConfigService])
], SupabaseUserGuard);
//# sourceMappingURL=supabase-user.guard.js.map